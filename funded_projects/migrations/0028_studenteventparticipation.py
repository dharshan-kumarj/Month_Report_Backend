...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('funded_projects', '0027_competitiveexamsuccess'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.CharField(choices=[('HACKATHON', 'Hackathon'), ('COMPETITION', 'Competition'), ('ONLINE_COURSE', 'Online Course')], max_length=20)),
